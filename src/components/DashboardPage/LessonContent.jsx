...
function LessonContent() {
    ...
    const { updateProgress } = useProgress(); // ✅ Changed
    ...
    let total = lessonsInField.length;
    ...
    const handleNext = () => {
        if (currentIndex + 1 < lessonsInField.length) {
            ...
            const newPercentage = ((nextIndex + 1) / total) * 100;
            updateProgress(targetFieldId, newPercentage); // ✅ Update for this field only
        }
    };
